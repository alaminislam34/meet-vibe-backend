...
CREATE TABLE "Event" (
    ...
    "creationStep" INTEGER NOT NULL DEFAULT 1,
    "coverImage" TEXT,
    ...
    "venueType" TEXT NOT NULL DEFAULT 'OFFLINE',
    "venueName" TEXT,
    "address" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "ChatGroup_eventId_key" ON "ChatGroup"("eventId");
...
-- AddForeignKey
ALTER TABLE "ChatGroup" ADD CONSTRAINT "ChatGroup_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "Event"("id") ON DELETE CASCADE ON UPDATE CASCADE;
