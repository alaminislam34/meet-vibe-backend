...
export class AuthRepository {
   ...
   */
  async findUserWithLocalAccount(email: string): Promise<UserWithAccounts | null> {
   ...
   */
  async updateUserRecoveryCodes(userId: string, mfaRecoveryCodes: string[]): Promise<void> {
    await prisma.user.update({
      where: { id: userId },
   ...
   */
  async updateAccountPassword(userId: string, hashedPassword: string): Promise<void> {
   ...
   */
  async incrementFailedLoginAttempts(accountId: string, lockedUntil?: Date): Promise<void> {
   ...
   */
  async findSessionWithUser(token: string): Promise<SessionWithUser | null> {
   ...
   */
  async createVerification(data: CreateVerificationInput): Promise<Verification> {
   ...
   */
  async findVerification(input: FindVerificationInput): Promise<Verification | null> {
   ...
   */
  async deleteVerificationById(id: string): Promise<void> {
